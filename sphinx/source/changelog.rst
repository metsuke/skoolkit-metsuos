...
* Added the ``Screen``, ``ScreenFps`` and ``ScreenScale`` configuration
  parameters for :ref:`rzxplay.py <rzxplay-conf>` (to specify whether and at
  what frame rate and scale factor to display screen contents)
